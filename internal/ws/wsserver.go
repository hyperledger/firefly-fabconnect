...
type WebSocketServer interface {
	WebSocketChannels
	NewConnection(w http.ResponseWriter, r *http.Request, p httprouter.Params)
	Close()
}
...
func (s *webSocketServer) NewConnection(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
