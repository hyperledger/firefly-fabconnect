...
func (d *txDelayTracker) ReportSuccess(timeTaken time.Duration) {
...
func (d *txDelayTracker) avg() float64 {
	var sum = float64(0)
	var c = d.window - 1
...
func (d *txDelayTracker) add(val float64) {
